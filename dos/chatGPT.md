...
欢迎来到“真棒聊天GPT提示”存储库！这是用于 ChatGPT 模型的提示示例集合。
...
**[拥抱脸视图](https://huggingface.co/datasets/fka/awesome-chatgpt-prompts/)**
...
我写了一本免费的电子书**，名为“ChatGPT 提示的艺术：制作清晰有效的提示指南”。**
...
我写了一本名为**“如何使用 ChatGPT 赚钱：战略、技巧和战术”**的电子书。
...
我写了一本电子书，名为**“中途人工智能的艺术：从文本创建图像的指南”。**
...
> **桌面应用程序是[@lencx的一个非官方开源项目](https://github.com/lencx/ChatGPT)。它是ChatGPT网络界面的简单包装器，具有强大的附加功能。**
...
<details open="" class="details-reset border rounded-2" style="box-sizing: border-box; display: block; border: var(--borderWidth-thin, 1px) solid var(--color-border-default) !important; border-radius: var(--borderRadius-medium, 6px) !important; margin-top: 0px; margin-bottom: 16px; color: rgb(31, 35, 40); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, &quot;Noto Sans&quot;, Helvetica, Arial, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"><summary class="px-3 py-2" style="box-sizing: border-box; display: list-item; cursor: pointer; padding-top: var(--base-size-8, 8px) !important; padding-bottom: var(--base-size-8, 8px) !important; padding-right: var(--base-size-16, 16px) !important; padding-left: var(--base-size-16, 16px) !important; list-style: none; transition: color 80ms cubic-bezier(0.33, 1, 0.68, 1) 0s, background-color, box-shadow, border-color;"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-camera-video"><path d="M16 3.75v8.5a.75.75 0 0 1-1.136.643L11 10.575v.675A1.75 1.75 0 0 1 9.25 13h-7.5A1.75 1.75 0 0 1 0 11.25v-6.5C0 3.784.784 3 1.75 3h7.5c.966 0 1.75.784 1.75 1.75v.675l3.864-2.318A.75.75 0 0 1 16 3.75Zm-6.5 1a.25.25 0 0 0-.25-.25h-7.5a.25.25 0 0 0-.25.25v6.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-6.5ZM11 8.825l3.5 2.1v-5.85l-3.5 2.1Z"></path></svg><span>&nbsp;</span><span aria-label="视频描述提示.chat.mov" class="m-1" _mstaria-label="967668" _msthash="600" _msttexthash="13160394" style="box-sizing: border-box; margin: var(--base-size-4, 4px) !important;">提示.聊天.mov</span><span>&nbsp;</span><span class="dropdown-caret" style="box-sizing: border-box; border-bottom-color: rgba(0, 0, 0, 0); border-left-color: rgba(0, 0, 0, 0); border-right-color: rgba(0, 0, 0, 0); border-style: solid; border-width: var(--borderWidth-thicker, 4px) var(--borderWidth-thicker, 4px) 0; content: &quot;&quot;; display: inline-block; height: 0px; vertical-align: middle; width: 0px;"></span></summary><video src="https://github.com/f/awesome-chatgpt-prompts/assets/196477/6846398c-9ee7-4d7b-8fbe-b7c9e6daad23" data-canonical-src="https://user-images.githubusercontent.com/196477/207992596-6846398c-9ee7-4d7b-8fbe-b7c9e6daad23.mov" controls="controls" muted="muted" class="d-block rounded-bottom-2 border-top width-fit" style="box-sizing: border-box; display: block !important; border-top: var(--borderWidth-thin, 1px) solid var(--color-border-default) !important; border-bottom-right-radius: var(--borderRadius-medium, 6px) !important; border-bottom-left-radius: var(--borderRadius-medium, 6px) !important; max-width: 100%; max-height: 640px; min-height: 200px;"></video></details>
...
由 ChatGPT 生成的[@royforlife](https://github.com/royforlife)贡献
...
> 我希望你扮演一个文学评论家的角色。我将为您提供一些文学作品的摘录。您应该根据其类型、主题、情节结构、人物特征、语言和风格以及历史文化背景等方面提供在给定背景下的分析。最后，你应该更深入地理解它的含义和意义。我的第一个要求是“成为还是不成为，这是个问题。`language`

## 担任廉价旅行票务顾问

由[@goeksu](https://github.com/goeksu)提供
